...
class MCPTestClient:
    ...
    def __init__(self, server_script: str = "mcp_server.server", config: Optional[Dict[str, Any]] = None):
    ...
    async def _send_request(self, request: Dict[str, Any]):
        ...
        logger.debug(f"Sent request: {request.get('method', 'unknown')} (id: {request.get('id', 'none')})")
